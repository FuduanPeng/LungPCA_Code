...
with open(f'{prefix}/Data/Figure 4G.pkl', 'rb') as f:
    data = pickle.load(f)
...
for s in ['P24_AAH', 'P24_LUAD']:
    ...
    plot_category(adata = input, group = 'Histology', background_alpha=1, col_map = col_map_histology, 
                  output = f'{prefix}/Results/Figure 4G.{s}.Histology.png', figsize = (10, 10))
    ...
    label_image.save(f'{prefix}/Results/Figure 4G.'+str(s)+'.MPs.png')
